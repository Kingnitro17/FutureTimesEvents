...
import type { Event, DbEvent, TicketTier, Ticket } from '@/types';
...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const mappedEvent = mapDbEvent(evData as DbEvent);
      ...
      if (tiers && tiers.length > 0) {
        ...
        setTier(mappedTiers.find(t => t.id === tierId) || mappedTiers[0]);
      }
      setLoadingData(false);
    })();
  }, [id, tierId]);
  ...
  if (!event || !tier) return (
    <div className="min-h-screen page-offset flex items-center justify-center">
      <div className="card p-10 text-center rounded-3xl">
        ...
        <h3 className="type-h3 text-[var(--text)] mb-3">Event or Tier not found</h3>
