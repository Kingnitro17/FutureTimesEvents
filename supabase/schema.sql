...
-- ============================================
-- These explicitly grant access to the Data API roles, which is required
-- by default for all new tables after May 30, 2026, and all tables after Oct 30, 2026.

GRANT SELECT, INSERT, UPDATE, DELETE ON public.profiles TO anon, authenticated, service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.events TO anon, authenticated, service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.ticket_tiers TO anon, authenticated, service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.tickets TO anon, authenticated, service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.attendees TO anon, authenticated, service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.saved_events TO anon, authenticated, service_role;
